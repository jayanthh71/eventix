...
export default function EventCard(event: Event) {
  ...
  return (
    <Link
      ...
      className="group relative overflow-hidden rounded-xl border border-gray-700 bg-gradient-to-br from-gray-800 to-gray-900 transition-all duration-300 hover:scale-105 hover:border-gray-600 hover:shadow-2xl hover:shadow-blue-500/20"
    >
      ...
      <div className="font-anek p-5">
        ...
        <div className="mt-4">
          <div
            className={`w-full rounded-lg bg-gradient-to-r text-center ${gradientClass} group-hover:bg-gradient-to-r group-hover:${hoverGradientClass} px-4 py-2 text-sm font-bold text-white shadow-lg transition-all duration-200`}
          >
            {isMovie ? "Book Tickets" : "Get Tickets"}
          </div>
        </div>
      </div>
    </Link>
